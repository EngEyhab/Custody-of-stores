    ...
    public partial class Queries : Form
    {
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand command = new SqlCommand("SELECT [3hdt-shon-edaria].dbo.fea.fea_name as الفئة, [3hdt-shon-edaria].dbo.fea_type.fea_type_name as الصنف,  [3hdt-shon-edaria].dbo.fea_description.fea_description_name as 'نوع الصنف',  [3hdt-shon-edaria].dbo.store.count as العدد,  [3hdt-shon-edaria].dbo.store.insert_date as 'تاريخ الادخال',  [3hdt-shon-edaria].dbo.Keta.keta_name as القطاع, [3hdt-shon-edaria].dbo.manfaz.manfaz_name as المنفذ  , [3hdt-shon-edaria].dbo.fea_description.fea_description_code AS 'كود الصنف' from [3hdt-shon-edaria].dbo.store  ,[3hdt-shon-edaria].dbo.fea  ,[3hdt-shon-edaria].dbo.fea_description  ,[3hdt-shon-edaria].dbo.fea_type  ,[3hdt-shon-edaria].dbo.manfaz ,[3hdt-shon-edaria].dbo.Keta   where  [3hdt-shon-edaria].dbo.store.fea_descripton_id = [3hdt-shon-edaria].dbo.fea_description.fea_descripton_id  and [3hdt-shon-edaria].dbo.store.keta_id = [3hdt-shon-edaria].dbo.Keta.keta_id  and [3hdt-shon-edaria].dbo.store.manfaz_id = [3hdt-shon-edaria].dbo.manfaz.manfaz_id  and [3hdt-shon-edaria].dbo.store.fea_id = [3hdt-shon-edaria].dbo.fea.fea_id  and [3hdt-shon-edaria].dbo.store.fea_type_id = [3hdt-shon-edaria].dbo.fea_type.fea_type_id and ( [3hdt-shon-edaria].dbo.store.keta_id =@keta_id OR @keta_id = 0) and ( [3hdt-shon-edaria].dbo.store.manfaz_id =@manfaz_id OR @manfaz_id = 0) and ( [3hdt-shon-edaria].dbo.store.fea_id =@fea_id OR @fea_id = 0) and ( [3hdt-shon-edaria].dbo.store.fea_type_id =@fea_type_id OR @fea_type_id = 0) and ( [3hdt-shon-edaria].dbo.store.fea_descripton_id =@fea_descripton_id OR @fea_descripton_id = 0) order by [3hdt-shon-edaria].[dbo].[store].store_id ASC", con);
